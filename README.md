...
Selects between a cubic B�zier curve (0) and quadratic B�zier curve (1). 0 gives more weight to the angle at the start and end points, and will deviate less from the eotf curve at the start.
